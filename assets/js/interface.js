...
//var minersAddr = '0x0756e796744ac13a6641771140Fd446584F082A2';
//var tokenAddr = '0x6820a83db204562bc0381be48d1754a73497172a';

var minersAddr = '0x562279C9fC65E3493c6f5c5F27ff5b9998Aaf9Ff';
var tokenAddr = '0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c';
var minersAbi =
[
	{
		"constant": true,
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + trx + " BTC in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + trx + " BTC first");
	} else {
